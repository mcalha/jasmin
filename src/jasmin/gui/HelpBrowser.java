...
public class HelpBrowser extends javax.swing.JPanel {
                ...
                return new HTMLEditorKit.HTMLFactory() {
                    ...
                    public View create(Element elem) {
                        ...
                        if (o instanceof HTML.Tag) {
                            ...
                            } else if (kind.toString().equalsIgnoreCase("autosavebox")) {
                                return new ComponentView(elem) {

                                    protected Component createComponent() {
                                        autoSave.setSelected(mframe.getProperty("autosave", 1) == 1);
                                        return autoSave;
                                    }
                                };
                            } else if (kind.toString().equalsIgnoreCase("repositorySelector")) {
                                return new ComponentView(elem) {
    ...
    private void initComponents() {
        ...
        repositoryS = new javax.swing.JComboBox();
        ...
        repositoryS.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "32", "64"}));
        repositoryS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                repositorySActionPerformed(evt);
            }
        });
    ...
    private void autoSaveStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_autoSaveStateChanged
        boolean selected = autoSave.isSelected();
        mframe.putProperty("autosave", selected ? 1 : 0);
    }//GEN-LAST:event_autoSaveStateChanged

    private void repositorySActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_repositorySActionPerformed
        mframe.putProperty("repository", repositoryS.getSelectedItem() + "");
    }//GEN-LAST:event_repositorySActionPerformed
    ...
    private javax.swing.JComboBox<String> repositoryS;
