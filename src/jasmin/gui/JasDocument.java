...
public final class JasDocument extends javax.swing.JPanel {
    ...
    /**
     * @return The number of excuted lines since last gui update. Is used to
    ...
    /**
     * @param title Sets the title and updates it in the actual frame.
     */
    ...
    /**
     * update highlighting of registers and the memory cells they are pointing
     * to
     */
    ...
    //highlight colors
    //para mudar e preciso alterar os registos verificar caminho que eles vao dar e modificar consoante o java higthligth
    ...
    private void initComponents() {
        ...
        jSplitPane1.setMaximumSize(new java.awt.Dimension(900, 900));
        jSplitPane1.setMinimumSize(new java.awt.Dimension(300, 500));
        ...
        jSplitPane6.setMaximumSize(new java.awt.Dimension(600, 1200));
        jSplitPane6.setMinimumSize(new java.awt.Dimension(300, 600));
        jSplitPane6.setName(""); // NOI18N
        jSplitPane6.setPreferredSize(new java.awt.Dimension(300, 600));

        jPanel11.setBorder(javax.swing.BorderFactory.createTitledBorder("Stack"));
        jPanel11.setMaximumSize(new java.awt.Dimension(450, 400));
        ...
        jPanel6.setMaximumSize(new java.awt.Dimension(450, 450));
        ...
        jTabbedPane3.setPreferredSize(new java.awt.Dimension(200, 248));

        jToolBar5.setFloatable(false);
        jToolBar5.setOrientation(javax.swing.SwingConstants.VERTICAL);
        jToolBar5.setRollover(true);
        jToolBar5.setAutoscrolls(true);
        jToolBar5.setMinimumSize(new java.awt.Dimension(210, 74));
        ...
        jScrollPane3.setMinimumSize(new java.awt.Dimension(2, 2));
    ...
    /**
     * The keyword of the current context help. Is used for deciding if the help
     * should be updated.
     */
     ...
     *
     * @param keyword The name of the command for which the context help should
     * be set.
     */
