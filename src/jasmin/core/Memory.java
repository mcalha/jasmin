...
/**
 * replacement for the object Byte which is signed. Additionally there is a
 * dirty tag to trace when the byte has been changed. Serializable in order to
 * be able to be saved to file by ObjectOutputStream
 *
 * @author Yang Guo
 */
public class Memory implements Serializable, Cloneable {
    ...
    // CONSTRUCTORS
    /**
     * sets the newly constructed unsigned byte to given value the dirty tag is
     * set
     *
